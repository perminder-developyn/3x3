<main>
    ...
    <AddPerson on:newPerson={addPersonToTable}/>
    <OrderList />
    <GameList />
    <ListToGrid />
    <Mystery8Ball />
...
import QuizTest from './components/quizTest.svelte';
...
import Mystery8Ball from './components/mystery8Ball.svelte';
import ListToGrid from './components/listToGrid.svelte';
